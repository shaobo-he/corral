...
namespace cba
{
    ...
    public class CoveragePass : VerificationPass
    {
        ...
        public override CBAProgram runCBAPass(CBAProgram p)
        {
            ...
            int oldErrorLimit = BoogieUtil.BoogieOptions.ErrorLimit;

            var done = false;
            do
            {
                // Set the number of traces returned by boogie in one shot                
                BoogieUtil.BoogieOptions.ErrorLimit = procsNotCovered.Count();
            ...
            BoogieUtil.BoogieOptions.ErrorLimit = oldErrorLimit;
